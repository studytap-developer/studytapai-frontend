  ...
  if (!user) {
    return (
      <div className="min-h-screen flex flex-col bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white relative overflow-hidden">
        ...
        {/* Main Content */}
        <div className="flex-grow flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8 relative z-10">
          <motion.div
            initial={{ opacity: 0, y: 50 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 1, ease: "easeOut" }}
          ...
          >
            ...
            >
              ...
              <motion.p
                ...
                animate={{ opacity: 1 }}
                transition={{ delay: 0.5, duration: 0.8 }}
                className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-300 mb-6 sm:mb-8 lg:mb-12 px-4 leading-relaxed"
              >
                Your intelligent study companion
              </motion.p>
            </motion.div>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={signInWithGoogle}
              className="px-6 py-3 sm:px-8 sm:py-4 lg:px-10 lg:py-5 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full font-semibold text-base sm:text-lg lg:text-xl transition-all duration-300 hover:from-blue-700 hover:to-purple-700 shadow-lg hover:shadow-2xl w-full sm:w-auto min-w-[200px] sm:min-w-[250px]"
            >
              Sign in with Google
            </motion.button>
          </motion.div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center text-xs sm:text-sm text-gray-400 space-y-3 sm:space-y-4">
              <div className="flex flex-col sm:flex-row items-center justify-center space-y-2 sm:space-y-0 sm:space-x-4">
                <button
                  onClick={() => setShowPrivacyModal(true)}
                  className="hover:underline hover:text-white transition-colors px-2 py-1"
                >
                  Privacy Policy
                </button>
